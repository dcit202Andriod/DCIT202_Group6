...
public class AddStudentActivity extends Activity {
	...
	private final String[] branchString = new String[] { "CSE","IT","EE","PE"};
	private final String[] yearString = new String[] {"FE","SE","TE","BE"};
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		cancelButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v)
			{
				Intent i = new Intent(AddStudentActivity.this, MenuActivity.class);
				startActivity(i);
