...
public class ViewAttendancePerStudentActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		for(AttendanceBean attendanceBean : attendanceBeanList)
		{
			...
			users1 =""+attendanceBean.getAttendance_session_id();
			users1= users1.trim();

			Student_no = attendanceBean.getAttendance_student_id()+"  "+ studentBean.getStudent_mobilenumber();
			Log.d(TAG, "onCreate: "+users1);
			//Toast.makeText(ViewAttendancePerStudentActivity.this,users,Toast.LENGTH_SHORT).show();
		}
